...
// Big Temp/ROR readouts on Trident's LVGL dashboard (lvgl-ui branch) want
// something larger than the 14pt default.
#define LV_FONT_MONTSERRAT_32 1
#define LV_FONT_MONTSERRAT_34 0
#define LV_FONT_MONTSERRAT_36 0
#define LV_FONT_MONTSERRAT_38 0
// Bumped from 32 -> 40 for the Temp/ROR tiles per user feedback ("bigger").
